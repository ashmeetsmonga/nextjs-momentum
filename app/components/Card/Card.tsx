...
const Card: FC<CardProps> = ({ type }) => {
  return (
    <div className={`w-full bg-white rounded-lg p-4 border ${TASK_BORDER_COLORS[type]} space-y-2`}>
      ...
      <p className="font-light text-xs">Create and integrate a cohesive design system to ensure consistency, scalability, and efficiency across all UI components and interfaces.</p>
      <div className="flex">
